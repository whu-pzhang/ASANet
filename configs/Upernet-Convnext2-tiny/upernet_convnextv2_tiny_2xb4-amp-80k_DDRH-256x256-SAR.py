_base_ = [
    ...
    '../_base_/datasets/ddrh-single_256x256.py',
]
...
data_preprocessor = dict(
    ...
    size=crop_size,
    # RGB,SAR
    mean=[53.837, 53.837, 53.837],
    std=[48.475, 48.475, 48.475],
    bgr_to_rgb=False,
    pad_val=0,
    seg_pad_val=255)
...
model = dict(
    ...
    auxiliary_head=dict(type='mmseg.FCNHead',
                        in_channels=384,
                        in_index=2,
                        channels=128,
                        num_convs=1,
