...
class CustomLearningRateDecayOptimizerConstructor(
    ...
    def add_params(self, params, module, **kwargs):
        ...
        for name, param in module.named_parameters():
            ...
            if 'layer_wise' in decay_type:
                if 'ASANet' in module.backbone.__class__.__name__:
                    layer_id = get_layer_id_for_convnext(
                        new_name, self.paramwise_cfg.get('num_layers'))
                ...
                if 'ASANet' in module.backbone.__class__.__name__:
                    layer_id = get_stage_id_for_convnext(new_name, num_layers)
                    print_log(f'set param {name} as id {layer_id}')
                else:
                    raise NotImplementedError()
...
@OPTIM_WRAPPER_CONSTRUCTORS.register_module()
class CustomLayerDecayOptimizerConstructor(
        CustomLearningRateDecayOptimizerConstructor):
    """Different learning rates are set for different layers of backbone.
